# <ins>Setting up check50 and submit50 from CS50 to work on local Vscode </ins> 
...
\
__Step 3:__ To set up a personal access token https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token follow the documentation but essentially just need to go to settings in github, developer settings, then personal access tokens classic, and configure the time and allow the permisions ans save then this token is then used as the password field. 
